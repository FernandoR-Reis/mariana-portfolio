...
const translations = {
  en: {
    ...
    text: [
      ...
      ['.tl-item:nth-child(1) .tl-desc', 'Responsible for the operational management of two group units, from team leadership to process standardization.'],
      ['.tl-item:nth-child(2) .tl-desc', 'Planning and execution of corporate events, with contract management and sponsor relationships.'],
      ['.tl-item:nth-child(3) .tl-desc', 'Full unit operation management, from financial control to menu and supplier development.'],
      ['.tl-item:nth-child(4) .tl-desc', 'Full operation implementation and administration, from people management to financial control.'],
      ['.tl-item:nth-child(5) .tl-desc', 'Operation implementation from team formation to operational and financial planning.'],
      ['.tl-item:nth-child(6) .tl-desc', 'Food & Beverage operations management, supervising kitchen, service floor, and bar operations.'],
      ['.tl-item:nth-child(1) .tl-tag:nth-child(1)', 'Hiring & training'],
      ['.tl-item:nth-child(1) .tl-tag:nth-child(2)', 'Leadership development'],
      ['.tl-item:nth-child(1) .tl-tag:nth-child(3)', 'COGS control'],
      ['.tl-item:nth-child(1) .tl-tag:nth-child(4)', 'P&L development'],
      ['.tl-item:nth-child(1) .tl-tag:nth-child(5)', 'Operational standardization'],
      ['.tl-item:nth-child(1) .tl-tag:nth-child(6)', 'Menu development'],
      ['.tl-item:nth-child(1) .tl-tag:nth-child(7)', 'Unit auditing'],
      ['.tl-item:nth-child(2) .tl-tag:nth-child(1)', 'Events & VIP lounges management'],
      ['.tl-item:nth-child(2) .tl-tag:nth-child(2)', 'Sponsor negotiation'],
      ['.tl-item:nth-child(2) .tl-tag:nth-child(3)', 'Contract management'],
      ['.tl-item:nth-child(2) .tl-tag:nth-child(4)', 'Partner relationship management'],
      ['.tl-item:nth-child(2) .tl-tag:nth-child(5)', 'Commercial opportunities'],
      ['.tl-item:nth-child(3) .tl-tag:nth-child(1)', 'Financial management'],
      ['.tl-item:nth-child(3) .tl-tag:nth-child(2)', 'Purchasing & inventory'],
      ['.tl-item:nth-child(3) .tl-tag:nth-child(3)', 'Team development'],
      ['.tl-item:nth-child(3) .tl-tag:nth-child(4)', 'Menu development'],
      ['.tl-item:nth-child(3) .tl-tag:nth-child(5)', 'Operational planning'],
      ['.tl-item:nth-child(4) .tl-tag:nth-child(1)', 'Operational implementation'],
      ['.tl-item:nth-child(4) .tl-tag:nth-child(2)', 'People management'],
      ['.tl-item:nth-child(4) .tl-tag:nth-child(3)', 'Financial control'],
      ['.tl-item:nth-child(4) .tl-tag:nth-child(4)', 'Supplier development'],
      ['.tl-item:nth-child(5) .tl-tag:nth-child(1)', 'Process implementation'],
      ['.tl-item:nth-child(5) .tl-tag:nth-child(2)', 'Training'],
      ['.tl-item:nth-child(5) .tl-tag:nth-child(3)', 'Financial management'],
      ['.tl-item:nth-child(6) .tl-tag:nth-child(1)', 'Cost control'],
      ['.tl-item:nth-child(6) .tl-tag:nth-child(2)', 'Inventories'],
      ['.tl-item:nth-child(6) .tl-tag:nth-child(3)', 'Event organization'],
      ['.tl-item:nth-child(6) .tl-tag:nth-child(4)', 'Continuous improvement'],
      ...
      ['.comp-cat:nth-child(1) .comp-list li:nth-child(1)', 'Operation implementation'],
      ['.comp-cat:nth-child(1) .comp-list li:nth-child(2)', 'Inventory management'],
      ['.comp-cat:nth-child(1) .comp-list li:nth-child(3)', 'Process standardization'],
      ['.comp-cat:nth-child(1) .comp-list li:nth-child(4)', 'Unit auditing'],
      ['.comp-cat:nth-child(2) .comp-list li:nth-child(1)', 'Commercial development'],
      ['.comp-cat:nth-child(2) .comp-list li:nth-child(2)', 'Partner relationship management'],
      ['.comp-cat:nth-child(2) .comp-list li:nth-child(3)', 'Customer service'],
      ['.comp-cat:nth-child(2) .comp-list li:nth-child(4)', 'Contract management'],
      ['.comp-cat:nth-child(3) .comp-list li:nth-child(1)', 'Supplier management'],
      ['.comp-cat:nth-child(3) .comp-list li:nth-child(2)', 'Schedule control'],
      ['.comp-cat:nth-child(3) .comp-list li:nth-child(3)', 'Contract management'],
      ['.comp-cat:nth-child(3) .comp-list li:nth-child(4)', 'Administrative routines'],
      ['.comp-cat:nth-child(4) .comp-list li:nth-child(1)', 'COGS - Cost of Goods Sold'],
      ['.comp-cat:nth-child(4) .comp-list li:nth-child(2)', 'P&L'],
      ['.comp-cat:nth-child(4) .comp-list li:nth-child(3)', 'Operational KPIs'],
      ['.comp-cat:nth-child(4) .comp-list li:nth-child(4)', 'Results control'],
      ['.comp-cat:nth-child(5) .comp-list li:nth-child(1)', 'Team leadership'],
      ['.comp-cat:nth-child(5) .comp-list li:nth-child(2)', 'Hiring & training'],
      ['.comp-cat:nth-child(5) .comp-list li:nth-child(3)', 'Leadership development'],
      ['.comp-cat:nth-child(5) .comp-list li:nth-child(4)', 'Schedule management'],
      ['.comp-cat:nth-child(6) .comp-list li:nth-child(1)', 'Supplier negotiation'],
      ['.comp-cat:nth-child(6) .comp-list li:nth-child(2)', 'Strategic purchasing'],
      ['.comp-cat:nth-child(6) .comp-list li:nth-child(3)', 'Inventory management'],
      ['.comp-cat:nth-child(6) .comp-list li:nth-child(4)', 'Supplier development'],
      ['.comp-cat:nth-child(7) .comp-list li:nth-child(1)', 'Planning and execution'],
      ['.comp-cat:nth-child(7) .comp-list li:nth-child(2)', 'VIP lounge management'],
      ['.comp-cat:nth-child(7) .comp-list li:nth-child(3)', 'Sponsor negotiation'],
      ['.comp-cat:nth-child(7) .comp-list li:nth-child(4)', 'Supplier coordination'],
      ['.comp-cat:nth-child(8) .comp-list li:nth-child(1)', 'Operational structuring'],
      ['.comp-cat:nth-child(8) .comp-list li:nth-child(2)', 'Goal definition'],
      ['.comp-cat:nth-child(8) .comp-list li:nth-child(3)', 'Metrics management'],
      ['.comp-cat:nth-child(8) .comp-list li:nth-child(4)', 'Long-term vision'],
      ['.comp-cat:nth-child(9) .comp-list li:nth-child(1)', 'Process review'],
      ['.comp-cat:nth-child(9) .comp-list li:nth-child(2)', 'Improvement projects'],
      ['.comp-cat:nth-child(9) .comp-list li:nth-child(3)', 'Quality standardization'],
      ['.comp-cat:nth-child(9) .comp-list li:nth-child(4)', 'Profitability optimization'],
  ...
  de: {
    ...
    text: [
      ...
      ['.tl-item:nth-child(1) .tl-desc', 'Verantwortlich für das operative Management von zwei Standorten der Gruppe, von der Teamführung bis zur Prozessstandardisierung.'],
      ['.tl-item:nth-child(2) .tl-desc', 'Planung und Durchführung von Firmenevents mit Vertragsmanagement und Sponsorenbetreuung.'],
      ['.tl-item:nth-child(3) .tl-desc', 'Ganzheitliche Standortsteuerung von Finanzmanagement bis Speisekarten- und Lieferantenentwicklung.'],
      ['.tl-item:nth-child(4) .tl-desc', 'Vollständige Einführung und Administration des Betriebs von Personalführung bis Finanzkontrolle.'],
      ['.tl-item:nth-child(5) .tl-desc', 'Aufbau des Betriebs von der Teambildung bis zur operativen und finanziellen Planung.'],
      ['.tl-item:nth-child(6) .tl-desc', 'Operative Steuerung von Food & Beverage mit Aufsicht über Küche, Service und Bar.'],
      ['.tl-item:nth-child(1) .tl-tag:nth-child(1)', 'Einstellung & Schulung'],
      ['.tl-item:nth-child(1) .tl-tag:nth-child(2)', 'Führungskräfteentwicklung'],
      ['.tl-item:nth-child(1) .tl-tag:nth-child(3)', 'COGS-Kontrolle'],
      ['.tl-item:nth-child(1) .tl-tag:nth-child(4)', 'GuV-Erstellung'],
      ['.tl-item:nth-child(1) .tl-tag:nth-child(5)', 'Operative Standardisierung'],
      ['.tl-item:nth-child(1) .tl-tag:nth-child(6)', 'Speisekartenentwicklung'],
      ['.tl-item:nth-child(1) .tl-tag:nth-child(7)', 'Standort-Audits'],
      ['.tl-item:nth-child(2) .tl-tag:nth-child(1)', 'Event- & VIP-Lounge-Management'],
      ['.tl-item:nth-child(2) .tl-tag:nth-child(2)', 'Sponsorenverhandlung'],
      ['.tl-item:nth-child(2) .tl-tag:nth-child(3)', 'Vertragsmanagement'],
      ['.tl-item:nth-child(2) .tl-tag:nth-child(4)', 'Partnerbeziehungsmanagement'],
      ['.tl-item:nth-child(2) .tl-tag:nth-child(5)', 'Kommerzielle Chancen'],
      ['.tl-item:nth-child(3) .tl-tag:nth-child(1)', 'Finanzmanagement'],
      ['.tl-item:nth-child(3) .tl-tag:nth-child(2)', 'Einkauf & Lager'],
      ['.tl-item:nth-child(3) .tl-tag:nth-child(3)', 'Teamentwicklung'],
      ['.tl-item:nth-child(3) .tl-tag:nth-child(4)', 'Speisekartenentwicklung'],
      ['.tl-item:nth-child(3) .tl-tag:nth-child(5)', 'Operative Planung'],
      ['.tl-item:nth-child(4) .tl-tag:nth-child(1)', 'Betriebseinführung'],
      ['.tl-item:nth-child(4) .tl-tag:nth-child(2)', 'Personalführung'],
      ['.tl-item:nth-child(4) .tl-tag:nth-child(3)', 'Finanzkontrolle'],
      ['.tl-item:nth-child(4) .tl-tag:nth-child(4)', 'Lieferantenentwicklung'],
      ['.tl-item:nth-child(5) .tl-tag:nth-child(1)', 'Prozessimplementierung'],
      ['.tl-item:nth-child(5) .tl-tag:nth-child(2)', 'Schulungen'],
      ['.tl-item:nth-child(5) .tl-tag:nth-child(3)', 'Finanzmanagement'],
      ['.tl-item:nth-child(6) .tl-tag:nth-child(1)', 'Kostenkontrolle'],
      ['.tl-item:nth-child(6) .tl-tag:nth-child(2)', 'Inventuren'],
      ['.tl-item:nth-child(6) .tl-tag:nth-child(3)', 'Eventorganisation'],
      ['.tl-item:nth-child(6) .tl-tag:nth-child(4)', 'Kontinuierliche Verbesserung'],
      ...
      ['.comp-cat:nth-child(1) .comp-list li:nth-child(1)', 'Betriebseinführung'],
      ['.comp-cat:nth-child(1) .comp-list li:nth-child(2)', 'Lagerverwaltung'],
      ['.comp-cat:nth-child(1) .comp-list li:nth-child(3)', 'Prozessstandardisierung'],
      ['.comp-cat:nth-child(1) .comp-list li:nth-child(4)', 'Standort-Audits'],
      ['.comp-cat:nth-child(2) .comp-list li:nth-child(1)', 'Geschäftsentwicklung'],
      ['.comp-cat:nth-child(2) .comp-list li:nth-child(2)', 'Partnerbeziehungsmanagement'],
      ['.comp-cat:nth-child(2) .comp-list li:nth-child(3)', 'Kundenservice'],
      ['.comp-cat:nth-child(2) .comp-list li:nth-child(4)', 'Vertragsmanagement'],
      ['.comp-cat:nth-child(3) .comp-list li:nth-child(1)', 'Lieferantenmanagement'],
      ['.comp-cat:nth-child(3) .comp-list li:nth-child(2)', 'Dienstplansteuerung'],
      ['.comp-cat:nth-child(3) .comp-list li:nth-child(3)', 'Vertragsmanagement'],
      ['.comp-cat:nth-child(3) .comp-list li:nth-child(4)', 'Administrative Routinen'],
      ['.comp-cat:nth-child(4) .comp-list li:nth-child(1)', 'COGS - Cost of Goods Sold'],
      ['.comp-cat:nth-child(4) .comp-list li:nth-child(2)', 'GuV'],
      ['.comp-cat:nth-child(4) .comp-list li:nth-child(3)', 'Operative KPIs'],
      ['.comp-cat:nth-child(4) .comp-list li:nth-child(4)', 'Ergebniskontrolle'],
      ['.comp-cat:nth-child(5) .comp-list li:nth-child(1)', 'Teamführung'],
      ['.comp-cat:nth-child(5) .comp-list li:nth-child(2)', 'Einstellung & Schulung'],
      ['.comp-cat:nth-child(5) .comp-list li:nth-child(3)', 'Führungskräfteentwicklung'],
      ['.comp-cat:nth-child(5) .comp-list li:nth-child(4)', 'Dienstplanmanagement'],
      ['.comp-cat:nth-child(6) .comp-list li:nth-child(1)', 'Lieferantenverhandlung'],
      ['.comp-cat:nth-child(6) .comp-list li:nth-child(2)', 'Strategischer Einkauf'],
      ['.comp-cat:nth-child(6) .comp-list li:nth-child(3)', 'Lagerverwaltung'],
      ['.comp-cat:nth-child(6) .comp-list li:nth-child(4)', 'Lieferantenentwicklung'],
      ['.comp-cat:nth-child(7) .comp-list li:nth-child(1)', 'Planung und Umsetzung'],
      ['.comp-cat:nth-child(7) .comp-list li:nth-child(2)', 'VIP-Lounge-Management'],
      ['.comp-cat:nth-child(7) .comp-list li:nth-child(3)', 'Sponsorenverhandlung'],
      ['.comp-cat:nth-child(7) .comp-list li:nth-child(4)', 'Lieferantenkoordination'],
      ['.comp-cat:nth-child(8) .comp-list li:nth-child(1)', 'Operative Strukturierung'],
      ['.comp-cat:nth-child(8) .comp-list li:nth-child(2)', 'Zieldefinition'],
      ['.comp-cat:nth-child(8) .comp-list li:nth-child(3)', 'Kennzahlenmanagement'],
      ['.comp-cat:nth-child(8) .comp-list li:nth-child(4)', 'Langfristige Perspektive'],
      ['.comp-cat:nth-child(9) .comp-list li:nth-child(1)', 'Prozessreview'],
      ['.comp-cat:nth-child(9) .comp-list li:nth-child(2)', 'Verbesserungsprojekte'],
      ['.comp-cat:nth-child(9) .comp-list li:nth-child(3)', 'Qualitätsstandardisierung'],
      ['.comp-cat:nth-child(9) .comp-list li:nth-child(4)', 'Rentabilitätsoptimierung'],
      ['#indicadores .eyebrow', 'Executive-Dashboard'],
...
const setActiveLanguageButton = (language) => {
  ...
  if (langCurrentFlag) {
    langCurrentFlag.textContent = flagMap[language] || flagMap.pt;
  }
};

const setLanguageMenuState = (isOpen) => {
  langSwitch?.classList.toggle('open', isOpen);
...
langToggle?.addEventListener('click', () => {
  ...
  setLanguageMenuState(Boolean(isOpen));
});
